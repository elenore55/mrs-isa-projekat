Vue.component('cottage-detailed-view2', {
                ...
                <div class="container card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex justify-content-end align-items-end me-4 mb-2">
                            <a v-if="cottage.editable" class="btn btn-primary btn-lg" :href="reserve">\Reserve</a>
                            <a v-if="cottage.editable" class="btn btn-primary btn-lg" :href="subscribe">Subscribe</a>
                        </div>
    ...
    computed: {
        ...
        reserve() {
            alert("Bila sam u rezervaciji");
            //return "/index.html#/reserve/" + this.$route.params.id;
        },

        subscribe() {
        alert("Bila sam u subscribovanju");
            //return "/index.html#/otherInformationCottage/" + this.$route.params.id;
        },
