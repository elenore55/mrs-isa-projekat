    ...
    template: `
        <div class="container">
            <div v-for="(c, i) in cottages" class="container card m-3">
                <div class="row">
                    <div class="col-3">
                        <img src="https://picsum.photos/id/81/200/300" class="card-img" width="200" height="200"  alt="cottage image">
                    </div>
                    <div class="col-7 card-body container">
                        ...
                        <div class="d-flex flex-row mt-3">
                            <a href="/#/updateCottage" class="btn btn-primary me-3 mt-2">View</a>
                            <button v-on:click="deleteCottage" class="btn btn-danger mt-2">Delete</button>
                        </div>
                    </div>
                </div>
                <div class="row">
