    ...
    <form style="width: 600px; margin: auto">
        ...
        <div class="row">
            <div class="form-group">
                <label>Name</label>
                <input type="text" v-model="instruktorPI.profileDataDTO.name" class="form-control">          
            </div>
            <div class="form-group">
                <label>Surname</label>
                <input type="text" class="form-control" v-model="instruktorPI.profileDataDTO.surname">          
            </div>
            <div class="form-group">
                <label>Email</label>
                <input type="text" class="form-control" v-model="instruktorPI.profileDataDTO.email">          
            </div>
            <div class="form-group">
                <label>Phone number</label>
                <input type="text" class="form-control" v-model="instruktorPI.profileDataDTO.phoneNumber">          
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    <label>Country</label>
                    <input type="text" class="form-control" v-model="instruktorPI.profileDataDTO.address.country">          
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label>City</label>
                    <input type="text" class="form-control" v-model="instruktorPI.profileDataDTO.address.city">          
                </div>
            </div>
            <div class="col">
                <div class="form-group">
