        ...
        <div class="container">
            <div class="row my-4 mx-1">
                ...
                <div class="col form-floating">
                    <input v-on:focus="errors.description = false" v-model="ship.description" type="text" class="form-control" id="desc-input" required/>
            ...
            <div class="row my-4 mx-1">
                ...
                <div class="col form-floating">
                    <textarea v-model="ship.additionalInfo" class="form-control mt-5" id="info-textarea" style="height: 150px"></textarea>
